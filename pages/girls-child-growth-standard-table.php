...
?>
 <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"> <i class="fa fa-table"></i> Child Growth Standard [girls]</h1>
            </div>
            <?php
                ...
                <div class="panel panel-default" style="    margin-top: 1em;">
                    ...
                    <div class="panel-body"> 
                      <form method="POST" action="../cli/functions.php">
                        ...
                        <input type="hidden" name="sex" value="girls">
                        <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Weight(kg) for Age of Girls (Months)
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                                ...
                                <tbody>
                                  <?php
                                    $sql = "SELECT 
                                            ...
                                            normal_to,
                                            overweight
                                            FROM girls_growth_table ORDER BY age ASC";
