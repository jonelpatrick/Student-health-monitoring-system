...
?>
 <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"> <i class="fa fa-star fa-fw"></i>CSSDO</h1>
            </div>
            <!-- /.col-lg-12 -->
            <?php 
                if(isset($_GET['msg'])){
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        CSSDO Personal Detail        
                    </div>
                    <div class="panel-body">
                     <form action="manager-process.php" method="POST" enctype="multipart/form-data">
                        <div class="col-lg-3">
                            <div class="img-box">
                                  ...
                                  if (mysqli_num_rows($result) > 0) {                                     
                                      ...
                                      while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        if($row['gender']==1){
                                          ...
                                          echo '<tr onclick="javascript:showCSSDOModal(this);">';
                                           echo '<td>'.$row['aid'].'</td>';
        ...
        <div class="modal fade" id="cssdoModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabelCSSDO" aria-hidden="true" >
            <div class="modal-dialog" style="width:1080px;">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="myModalLabelCSSDO">CSSDO Detail <span id="liquidationDate" style="color:orange;"></span></h4>                                                
                    </div>

                    <form id="myform" action="manager-process.php" method="post" enctype="multipart/form-data" >
                       
                        <div class="modal-body cssdo-modal-body">
  ...
  <script language="javascript" type="text/javascript">
             ...
             function showCSSDOModal(row){

                var x=row.cells;
                 var id = x[0].innerHTML;
                
                $('.cssdo-modal-body').load('manager-modal.php?id=' + id,function(){
                     
                    $('#cssdoModal').modal({show:true}); 
